  ...
  return (
    <div className="w-[100%]">
      <form
        ...
        className="min-w-0 flex items-center w-full h-10 bg-[var(--color-yellow)] rounded"
      >
        <select
          name=""
          className="hidden lg:block p-2 bg-gray-300 text-black h-full text-xs xl:text-sm rounded-l"
          id=""
